...
// src/main.ts
var envSchema = import_zod12.z.object({
  PORT: import_zod12.z.coerce.number().default(3e3),
  JWT_SECRET: import_zod12.z.string().default("secret"),
  DATABASE_URL: import_zod12.z.string().default("postgres://admin:admin@localhost:5432/booktrack"),
  BUCKET_NAME: import_zod12.z.string().default("marcos-my-pi-test"),
  BUCKET_REGION: import_zod12.z.string().default("us-east-1")
});
