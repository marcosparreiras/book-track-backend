...
// src/domain/use-cases/get-book-use-case.spec.ts
describe("GetBookUseCase", () => {
  ...
  it("Should be able to get a book data enriched with comment with user data", () => __async(exports, null, function* () {
  ...
  it("Should not be able to get an unexistent book", () => __async(exports, null, function* () {
    const input = {
