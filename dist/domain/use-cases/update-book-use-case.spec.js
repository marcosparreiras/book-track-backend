...
// src/domain/use-cases/update-book-use-case.spec.ts
describe("UpdateBookUseCase", () => {
  ...
  it("Should be able to update a book data", () => __async(exports, null, function* () {
  ...
  it("Should not be able to update an unexistent book even with admin credentials", () => __async(exports, null, function* () {
    const admin = User.create({
      email: "johndeo@example.com",
      name: "John Doe",
      password: "123456"
