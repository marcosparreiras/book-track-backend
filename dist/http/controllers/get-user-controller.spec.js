...
// src/http/controllers/get-user-controller.spec.ts
...
describe("GET /me", () => {
  ...
  it("Should be able to get the profile of an authenticated user", () => __async(exports, null, function* () {
    const name = "John Doe";
    ...
    const response = yield (0, import_supertest.default)(app).get("/me").set({ Authorization: `Bearer ${token}` });
