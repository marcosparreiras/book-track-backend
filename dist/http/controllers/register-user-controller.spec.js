...
// src/http/controllers/register-user-controller.spec.ts
...
describe("POST /users", () => {
  ...
  it("Should be able to register a user", () => __async(exports, null, function* () {
    const requestBody = {
      name: "John Doe",
      email: "johndoe@example.com",
      password: "123456"
    };
    const response = yield (0, import_supertest.default)(app).post("/users").send(requestBody);
    expect(response.status).toEqual(201);
    expect(response.body.userId).toEqual(expect.any(String));
  }));
  it("Should not be able to register a user with invalid request data", () => __async(exports, null, function* () {
    const requestBody = {
      nome: "John Doe",
      email: "johndoe@example.com",
      password: "123456"
