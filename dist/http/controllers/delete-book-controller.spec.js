...
// src/http/controllers/delete-book-controller.spec.ts
...
describe("DELETE /book/:bookId", () => {
  ...
  it("Should be able to delete a book with admin credentials", () => __async(exports, null, function* () {
    ...
    const response = yield (0, import_supertest.default)(app).delete(`/book/${bookId}`).set({ Authorization: `Bearer ${token}` });
