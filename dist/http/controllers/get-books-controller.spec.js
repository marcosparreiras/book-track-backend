...
// src/http/controllers/get-books-controller.spec.ts
...
describe("GET /book", () => {
  ...
  it("Should be able to get books by page", () => __async(exports, null, function* () {
    const response = yield (0, import_supertest.default)(app).get(`/book?page=2&pageSize=3`);
  ...
  it("Should be able to serch books by title", () => __async(exports, null, function* () {
    const response = yield (0, import_supertest.default)(app).get(`/book?title=A0`);
    expect(response.status).toEqual(200);
