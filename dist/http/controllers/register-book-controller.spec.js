...
var require_dist = __commonJS({
  "node_modules/formidable/dist/index.cjs"(exports2) {
    ...
    function plugin$3(formidable2, options) {
      return __async(this, null, function* () {
        const self = this || formidable2;
        if (/octet-stream/i.test(self.headers["content-type"])) {
          yield init$2.call(self, self, options);
        }
        return self;
      });
    }
    function init$2(_self, _opts) {
      return __async(this, null, function* () {
        ...
        const file = yield this._newFile({
          newFilename,
          filepath,
          originalFilename,
          mimetype
...
--${str}`);
    ...
    function createInitMultipart(boundary) {
      return function initMultipart() {
        ...
        parser.on("data", (_0) => __async(this, [_0], function* ({ name, buffer, start, end }) {
          if (name === "partBegin") {
    ...
    var IncomingForm = class extends node_events.EventEmitter {
      ...
      parse(req, cb) {
        return __async(this, null, function* () {
          ...
          yield this.writeHeaders(req.headers);
          req.on("error", (err) => {
            this._error(err);
          }).on("aborted", () => {
            this.emit("aborted");
      ...
      _parseContentType() {
        return __async(this, null, function* () {
          ...
          const results = [];
          yield Promise.all(this._plugins.map((plugin2, idx) => __async(this, null, function* () {
            let pluginReturn = null;
            try {
              pluginReturn = (yield plugin2(this, this.options)) || this;
            } catch (err) {
      ...
      _newFile(_0) {
        return __async(this, arguments, function* ({ filepath, originalFilename, mimetype, newFilename }) {
          ...
          if (this.options.createDirsFromUploads) {
            try {
              yield createNecessaryDirectoriesAsync(filepath);
  ...
  "node_modules/superagent/lib/node/http2wrapper.js"(exports2) {
    ...
    var Request = class extends Stream {
      constructor(protocol, options) {
        ...
        delete options.path;
        const sessionOptions = __spreadValues({}, options);
...
// src/http/controllers/register-book-controller.spec.ts
...
function registerUserController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      const { name, email, password } = requestBodySchema.parse(request2.body);
...
// src/http/controllers/authenticate-user-controller.ts
function authenticateUserController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      const { email, password } = requestBodySchema.parse(request2.body);
...
function getUserController(request2, response, next) {
  return __async(this, null, function* () {
    try {
...
function tokenAuthenticationMiddleware(request2, _response, next) {
  const requestHeadersSchema = import_zod4.z.object({
    authorization: import_zod4.z.string()
  });
  try {
    const { authorization } = requestHeadersSchema.parse(request2.headers);
...
function updateUserAvatarController(request2, response, next) {
  return __async(this, null, function* () {
    try {
      const userId = request2.userId;
      const file = request2.file;
...
// src/http/controllers/register-book-controller.ts
function registerBookController(request2, response, next) {
  return __async(this, null, function* () {
...
// src/http/controllers/update-book-controller.ts
function updateBookController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const { bookId } = requestParamsSchema.parse(request2.params);
...
// src/http/controllers/delete-book-controller.ts
function deleteBookController(request2, response, next) {
  return __async(this, null, function* () {
...
// src/http/controllers/create-comment-controller.ts
function createCommentController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (!userId) throw new Error();
      const { bookId } = requestParamsSchema.parse(request2.params);
      const { content, rate } = requestBodySchema.parse(request2.body);
...
function deleteCommentController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      const userId = request2.userId;
      if (!userId) throw new Error();
      const { commentId } = requestParamsSchema.parse(request2.params);
...
// src/http/controllers/get-book-controller.ts
function getBookController(request2, response, next) {
  return __async(this, null, function* () {
...
// src/http/controllers/get-books-controller.ts
function getBooksController(request2, response, next) {
  return __async(this, null, function* () {
    ...
    try {
      const { page, pageSize, title } = requestQuerySchema.parse(request2.query);
...
describe("POST /book", () => {
  ...
  it("Should be able to register a book with admin credentials", () => __async(exports, null, function* () {
    const email = "johndoe@example.com";
    const password = "123456";
    const {
      body: { token }
    } = yield (0, import_supertest.default)(app).post("/session").send({ email, password });
    const response = yield (0, import_supertest.default)(app).post("/book").set({ Authorization: `Bearer ${token}` }).attach("bookImage", "assets/test-avatar.png").field("title", "Patterns of Enterprise Application Architecture").field("author", "John Doe").field("description", "Some fake book description").field("publishedAt", "2020-01-01");
    expect(response.status).toEqual(201);
    expect(response.body.bookId).toEqual(expect.any(String));
  }));
  it("Should not be able to create a book with a normal user credentials", () => __async(exports, null, function* () {
